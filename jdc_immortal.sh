...
sed -i -e 's/27328k/32448k/' -e 's/kmod-fs-ext4 kmod-mt7603 kmod-mt7615e/lsblk kmod-fs-ext4 e2fsprogs fdisk luci-app-wireguard/' -e 's/kmod-mt7615-firmware kmod-sdhci-mt7620 kmod-usb3/kmod-sdhci-mt7620/' openwrt/target/linux/ramips/image/mt7621.mk
...
sed -i -e 's/kmod-nf-nathelper/luci-app-ssr-plus/' -e 's/kmod-nf-nathelper-extra/luci-app-vlmcsd/' -e 's/kmod-ipt-raw/luci-app-upnp/' -e 's/luci-app-filetransfer/luci-app-udpxy/' openwrt/include/target.mk
